...
function countingTime(){
  count--; // countdown by 1 every second
...
let update = function () {
    ...
    let render = function () {
      if (bgReady) {
        ctx.drawImage(bgImage, 0, 0, 1200, 700);
      }
      if (heroReady) {
        ctx.drawImage(heroImage, heroX, heroY, heroImage.width = 80, heroImage.height = 80);
      }
      if (monsterReady) {
        ctx.drawImage(monsterImage, monsterX, monsterY, monsterImage.width = 80, monsterImage.height = 80);
      }
      if (obstacle1Ready) {
        ctx.drawImage(obstacle1Image, obstacle1X, obstacle1Y, obstacle1Image.width = 120, obstacle1Image.height = 120);
      }
      if (obstacle2Ready) {
        ctx.drawImage(obstacle2Image, obstacle2X, obstacle2Y, obstacle2Image.width = 120, obstacle2Image.height = 120);
      }
      ctx.font = "20px Arial";
